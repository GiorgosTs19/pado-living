...
import { ReactNode, useEffect, useRef, RefObject, Ref } from 'react';
...
export const ModalBody = ({ children, className }: { children: ReactNode; className?: string }) => {
  ...
  const modalRef: RefObject<HTMLDivElement | undefined> = useRef(undefined);
  const { setOpen } = useModal();
    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          <motion.div
            ref={modalRef as Ref<HTMLDivElement> | undefined}
            className={cn(
